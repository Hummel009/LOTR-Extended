...
public class Biomes {
	...
	public static void onInit() {
		...
		darkLandJungle = new BiomeDarkLandJungle(id--, true).setTemperatureRainfall(1.2f, 1.2f).setMinMaxHeight(0.1f, 0.1f).setColor(0x446820).setBiomeName("southJungle");
		...
		darkLandJungleEdge = new BiomeDarkLandJungleEdge(id--, true).setTemperatureRainfall(1.2f, 1.2f).setMinMaxHeight(0.1f, 0.1f).setColor(0x6C822C).setBiomeName("southJungleEdge");
		...
		darkLandSavannah = new BiomeDarkLandSavannah(id--, true).setTemperatureRainfall(1.2f, 1.2f).setMinMaxHeight(0.1f, 0.1f).setColor(0x89933C).setBiomeName("southSavannah");
		...
		darkLandYellowMountainsCold = new BiomeYellowMountains(id--, true).setTemperatureRainfall(0.0f, 0.0f).setMinMaxHeight(2.0f, 2.0f).setColor(0xE8CB66).setBiomeName("yellowMountains");
