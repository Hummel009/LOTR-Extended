...
public class Biomes {
	...
	public static void onInit() {
		darkLandYellowMountains = new YellowMountains(id--, true).setTemperatureRainfall(0.8f, 0.8f).setMinMaxHeight(2.0f, 2.0f).setColor(0xEAC643).setBiomeName("yellowMountains");
		darkLandTaiga = new SouthTaiga(id--, true).setTemperatureRainfall(0.4f, 0.4f).setMinMaxHeight(0.1f, 0.1f).setColor(0xA5C9AA).setBiomeName("southTaiga");
		darkLandTundra = new SouthTundra(id--, true).setTemperatureRainfall(0.4f, 0.4f).setMinMaxHeight(0.1f, 0.1f).setColor(0xA5C681).setBiomeName("southTundra");
		...
		darkLandJungle = new DarkLandJungle(id--, true).setTemperatureRainfall(1.2f, 1.2f).setMinMaxHeight(0.1f, 0.1f).setColor(0x446820).setBiomeName("southJungle");
		...
		darkLandJungleEdge = new DarkLandJungleEdge(id--, true).setTemperatureRainfall(1.2f, 1.2f).setMinMaxHeight(0.1f, 0.1f).setColor(0x6C822C).setBiomeName("southJungleEdge");
		...
		darkLandSavannah = new DarkLandSavannah(id--, true).setTemperatureRainfall(1.2f, 1.2f).setMinMaxHeight(0.1f, 0.1f).setColor(0x89933C).setBiomeName("southSavannah");
		...
		darkLandYellowMountainsCold = new YellowMountains(id--, true).setTemperatureRainfall(0.0f, 0.0f).setMinMaxHeight(2.0f, 2.0f).setColor(0xE8CB66).setBiomeName("yellowMountains");
